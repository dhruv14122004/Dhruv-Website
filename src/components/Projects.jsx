...
const projectData = [
  ...
  { id: 3, title: 'Hotel Management System', description: 'The system integrates both a standard calculator and  a price calculator, boosting its functionality. It also features a dynamic billing system, automating price calculations and ensuring precise invoicing for enhanced efficiency.', img:hotel },
  { id: 4, title: 'Forest Fire Detector', description: 'Developed a comprehensive forest fire detection system using Arduino, aimed at early identification and prevention of potential wildfires. The project involved the integration of varioussensors and communication modules to ensure real-time monitoring and timely response.', img:forrestfire}
];
